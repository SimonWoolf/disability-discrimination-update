...
describe PostsController do
  let(:valid_attributes) { { "title" => "MyText", "body" => "mybody" } }
  ...
  context 'correct http authentication' do
    ...
    describe "PUT update" do
      describe "with valid params" do
        it "updates the requested post" do
          ...
          Post.any_instance.should_receive(:update).with({ "title" => "MyText" })
          put :update, {:id => post.to_param, :post => { "title" => "MyText" }}
        end
    ...
    describe "DELETE destroy" do
      ...
      it "redirects to the posts list" do
        post = Post.create! valid_attributes
        delete :destroy, {:id => post.to_param}
        response.should redirect_to(admin_blog_path)
      end
    end
